...
export function LoginForm({ platformName, tagline, logoUrl }: LoginFormProps) {
  ...
  const displayTagline = tagline ?? "Cooperative innovation, delivered.";
    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-700 to-blue-600 px-8 py-8 text-white text-center">
          ...
          <p className="mt-2 text-sm text-blue-100 text-center">{displayTagline}</p>
        </div>
